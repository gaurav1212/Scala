...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var ans = new $c_sr_ObjectRef().init___O(elem);
  namedExpressions.foreach__F1__V(new $c_Lcalculator_Calculator$$anonfun$computeValues$1().init___sci_Map__sr_ObjectRef(namedExpressions, ans));
  return $as_sci_Map(ans.elem$1)
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var n = x3.name$2;
      expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(n, references);
      continue _eval
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  ...
  var sig = new $c_Lcalculator_Var().init___F0(expr);
  var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweetText$1) {
    return (function() {
      return ((140 - $m_Lcalculator_TweetLength$().calculator$TweetLength$$tweetLength__T__I($as_T(tweetText$1.apply__O()))) | 0)
    })
  })(tweetText));
  $c_Lcalculator_Signal.prototype.update__F0__V.call(sig, expr$1);
  return sig
});
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return (($uI(remainingCharsCount$1.apply__O()) > 14) ? "green" : (($uI(remainingCharsCount$1.apply__O()) >= 0) ? "orange" : "red"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.init___sci_Map__sr_ObjectRef = (function(namedExpressions$1, ans$1) {
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__V = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    var sig = $as_Lcalculator_Signal(x0$1.$$und2$f);
    var jsx$2 = this.ans$1$2;
    var jsx$1 = $as_sci_Map(this.ans$1$2.elem$1);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, str$1, sig$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(sig$1.apply__O()), $as_sci_Map(arg$outer.namedExpressions$1$f.$$minus__O__sc_Map(str$1)))
      })
    })(this, str, sig));
